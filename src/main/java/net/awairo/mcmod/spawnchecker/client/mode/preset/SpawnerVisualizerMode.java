...
import net.awairo.mcmod.spawnchecker.client.marker.MobSpawnerActivateAreaMarker;
import net.awairo.mcmod.spawnchecker.client.marker.MobSpawnerBlockMarker;
import net.awairo.mcmod.spawnchecker.client.marker.MobSpawnerPointMerker;
import net.awairo.mcmod.spawnchecker.client.marker.MobSpawnerSpawnAreaMarker;
import net.awairo.mcmod.spawnchecker.client.marker.MobSpawnerSpawnLimitAreaMarker;
 ...
 * @author alalwww
 */
public class SpawnerVisualizerMode extends PresetMode<SpawnerVisualizerMode> implements ConditionalMode
{
    ...
    @Override
    protected SpawnerVisualizerConfig config()
    {
        return configs().spawnerVisualizerMode;
    }
